 ...
 * 步骤 2 创建扩展了上述类的实体类。 Keyboard.java Monitor.java Mouse.java Computer.java
 * 步骤 3 定义一个表示访问者的接口。 ComputerPartVisitor.java
 * 步骤 4 创建实现了上述类的实体访问者。 ComputerPartDisplayVisitor.java
 * 步骤 5 使用 ComputerPartDisplayVisitor 来显示 Computer 的组成部分。 VisitorPatternDemo.java
 * 步骤 6 验证输出。
 *
 */
