...
import com.li.iterator.Container;
import com.li.state.impl.StartState;
import com.li.state.impl.StopState;
 ...
 * 步骤 2 创建实现接口的实体类。 StartState.java StopState.java
 * 步骤 3 创建 Context 类。 ntext.java
 * 步骤 4 使用 Context 来查看当状态 State 改变时的行为变化。 StatePatternDemo.java
 * 步骤 5 验证输出。
 */
