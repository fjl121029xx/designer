 ...
 * 步骤 2 创建扩展了上面抽象类的实体类。 Rectangle.java Square.java Circle.java
 * 步骤 3 创建一个类，从数据库获取实体类，并把它们存储在一个 Hashtable 中。ShapeCache.java
 * 步骤 4 PrototypePatternDemo 使用 ShapeCache 类来获取存储在 Hashtable 中的形状的克隆。 PrototypePatternDemo.java
 * 步骤 5 验证输出。
 */
