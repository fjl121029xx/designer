...
import com.li.command.impl.BuyStock;
import com.li.command.impl.SellStock;
 ...
 * 步骤 2 创建一个请求类。 Stock.java
 * 步骤 3 创建实现了 Order 接口的实体类。 BuyStock.java SellStock.java
 * 步骤 4 创建命令调用类。 Broker.java
 * 步骤 5 使用 Broker 类来接受并执行命令。 CommandPatternDemo.java
 */
