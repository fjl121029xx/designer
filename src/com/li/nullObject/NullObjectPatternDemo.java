 ...
 * 步骤 2 创建扩展了上述类的实体类。 RealCustomer.java NullCustomer.java
 * 步骤 3 创建 CustomerFactory 类。 CustomerFactory.java
 * 步骤 4 使用 CustomerFactory，基于客户传递的名字，来获取 RealCustomer 或 NullCustomer 对象。 NullPatternDemo.java
 * 步骤 5  验证输出。
 */
